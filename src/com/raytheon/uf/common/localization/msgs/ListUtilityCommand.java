...
public class ListUtilityCommand extends AbstractUtilityCommand {
	...
	public String logString() {
		String fExt = (fileExtension == null) ? "null" : String.format("\"%s\"", fileExtension);
		return String.format("\"subDirectory\":\"%s\", \"recursive\":\"%s\", " +
				"\"filesOnly\":\"%s\", \"localizedSite\":\"%s\", " +
				"\"fileExtension\":%s, \"context\":\"%s\"", 
				subDirectory, recursive, filesOnly, localizedSite, fExt, context);
	}
