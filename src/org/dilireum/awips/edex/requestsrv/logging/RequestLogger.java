...
public class RequestLogger implements ILocalizationPathObserver {
     ...
     * 
     * @param wsid String containing the workstation ID.
     * @param request Request object to be logged.
     */
     ...
     * modified.
     * 
     * @param file ILocalizationFile object representation of the file that
     * changed.
     */
    @Override
